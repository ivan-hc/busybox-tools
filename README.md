...
The site https://www.busybox.net is often subject to strong slowdowns, probably due to the lack of mirrors that can speed up not only the download of individual binaries **only for the latest release**, but also the connection to all pages, as well as to the homepage itself.
